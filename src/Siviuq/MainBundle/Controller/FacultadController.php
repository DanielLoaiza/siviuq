...
use Siviuq\MainBundle\Form\FacultadType;
...
class FacultadController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SiviuqMainBundle:Facultad')->findAll();
     ...
     * @Method("POST")
     * @Template("SiviuqMainBundle:Facultad:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SiviuqMainBundle:Facultad')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("SiviuqMainBundle:Facultad:edit.html.twig")
     */
